...
import * as knex from 'knex';
  ...
  export class Model {
    ...
    static extend(subclassConstructor: () => any): void;
  ...
  export interface QueryBuilder extends knex.QueryBuilder {
    ...
    // then(successHandler: (...args: any[]) => any, errorHandler: (...args: any[]) => any): Promise < any > ;
    // then(successHandler: (...args: any[]) => any): Promise < any > ;

    // map(mapper: () => any): Promise < any > ;

    // catch (errorHandler: (...args: any[]) => any): Promise < any > ;
